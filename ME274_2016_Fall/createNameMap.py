...
fileobj =  open('me274_blog_2016.xml') ##The name of your xml
'''
The new file which delete identity information
'''
fileobj2 = open('me274_201New.xml','w') ##create a new one
NameMap = dict()
x = 0
for line in fileobj:
...
pd.DataFrame.from_dict(NameMap,orient = 'index').to_csv('NameMap_2016S_new.csv')
