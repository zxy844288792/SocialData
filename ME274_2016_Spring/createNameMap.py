...
#fileobj =  open('me274basicmechanicsii.wordpress.2016-05-09.xml') ##The name of your xml
fileobj =  open('me274_blog_2016Fa copy.xml')
'''
The new file which delete identity information
'''
fileobj2 = open('me274_2016FNew.xml','w') ##create a new one
NameMap = dict()
x = 0
for line in fileobj:
...
pd.DataFrame.from_dict(NameMap,orient = 'index').to_csv('NameMap_2016Fall_new.csv')
